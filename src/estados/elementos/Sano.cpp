...
void
Sano::recibirGolpeDe (Entidad * jugador)
{
  ...
  if (elemento->estaRoto ())
    {
      ...
      jugador->getEstado < NotificadorDeGolpes >
	("notificador")->notificarGolpeAElemento (elemento);
  ...
  else
    {
      ...
      entidad->agregarComportamiento ("estado",
				      new RecibiendoGolpeElemento (entidad,
								   pausas));
    }
}
