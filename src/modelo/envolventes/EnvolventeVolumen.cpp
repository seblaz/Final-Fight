...
bool
EnvolventeVolumen::colisionaPorIzquierdaCon (EnvolventeVolumen * envolvente)
{
...
bool
EnvolventeVolumen::colisionaPorDerechaCon (EnvolventeVolumen * envolvente)
{
...
bool
EnvolventeVolumen::colisionaAbajoCon (EnvolventeVolumen * envolvente)
{
  ...
  return (x - ancho < envolvente->posicion->x + envolvente->ancho &&
	  ...
	  posicion->y - profundidad
	  && envolvente->posicion->y + envolvente->profundidad < posicion->y);
}

bool
EnvolventeVolumen::colisionaArribaCon (EnvolventeVolumen * envolvente)
{
  int x = this->posicion->getX ();
...
bool
EnvolventeVolumen::colisionaCon (EnvolventeVolumen * envolvente)
{
  return abs (posicion->x + ancho - envolvente->posicion->x) <
    (ancho + envolvente->ancho)
