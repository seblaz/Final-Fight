...
void
ModeloAutenticacion::serializar (ostream & stream)
{
...
void
ModeloAutenticacion::passwordIncorrecta ()
{
  lock_guard < mutex > lock (m);
...
void
ModeloAutenticacion::usuarioYaConectado ()
{
  lock_guard < mutex > lock (m);
...
void
ModeloAutenticacion::partidaCompleta ()
{
  lock_guard < mutex > lock (m);
