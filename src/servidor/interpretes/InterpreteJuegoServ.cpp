...
bool
InterpreteJuegoServ::interpretarAccion (ACCION accion, stringstream & s)
{
  ...
  switch (accion)
    ...
    case MODOTEST:
      Locator::logger ()->log (INFO,
			       "Se cambia el modo test del usuario " +
			       getUsuario ()->getUsuario () + ".");
      evento = new ModoTest (jugador);
      break;
    default:
      Locator::logger ()->log (ERROR,
			       "Se recibió una acción inválida en el juego.");
      return true;
    }
...
void
InterpreteJuegoServ::finalizarCliente ()
{
