...
void
VistaMenuSeleccion::graficar (SDL_Renderer * renderer)
{
  ...
  SDL_RenderCopy (renderer, sprite->getTexture (), &posicionEnSpriteIndicador,
		  &posicionEnPantalla);
}

string
VistaMenuSeleccion::getConfigPathMusica ()
{
